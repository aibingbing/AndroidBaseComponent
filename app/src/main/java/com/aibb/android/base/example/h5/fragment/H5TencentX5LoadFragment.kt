package com.aibb.android.base.example.h5.fragment
...
class H5TencentX5LoadFragment : Fragment() {

    companion object {
        const val TAG = "TencentX5LoadFragment"
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.h5_common_load_activity, null)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        initWebView()
        val url = arguments?.getString("url") ?: URL
        loadUrl(url)
    }
