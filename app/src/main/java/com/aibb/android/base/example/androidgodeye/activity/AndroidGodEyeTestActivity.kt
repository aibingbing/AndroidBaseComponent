package com.aibb.android.base.example.androidgodeye.activity
...
class AndroidGodEyeTestActivity : AppCompatActivity() {
    companion object {
        const val TAG = "AndroidGodEyeTestActivity"
    }
    ...
    private fun initFragment() {
        supportFragmentManager.beginTransaction()
            .add(R.id.fragmentContainer, H5TencentX5LoadFragment::class.java, Bundle().apply {
                putString("url", "https://github.com/Kyson/AndroidGodEye")
            }).commit()
    }
}