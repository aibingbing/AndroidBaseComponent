package com.aibb.android.base.example.litho.activity
...
class LithoTestActivity : AppCompatActivity() {

    companion object {
        const val TAG = "LithoTestActivity"
    }
    ...
    private fun initFragment() {
        supportFragmentManager.beginTransaction()
            .add(R.id.fragmentContainer, H5TencentX5LoadFragment::class.java, Bundle().apply {
                putString("url", "https://fblitho.com")
            }).commit()
    }
}