...
public class MultiTypeJsonParser<T> {
    ...
    public Gson getTargetParseGson() {
        if (targetParseGson == null) {
            targetParseGson = new GsonBuilder().registerTypeAdapter(targetClass, this.getBuilder().getTypeAdapter())
                    .create();
    ...
    public static class Builder<T> {
         ...
         * @return
         */
        public Builder<T> registerTypeElementValueWithClassType(
                String typeElementValue,
                Class<? extends T> classValue
        ) {
        ...
        public MultiTypeJsonParser<T> build(GsonBuilder gsonBuilder) {
            ...
            gsonBuilder.registerTypeAdapter(multiTypeJsonParser.targetClass, new TargetSerializer(multiTypeJsonParser));
            if (multiTypeJsonParser.targetUpperLevelClass != null) {
                gsonBuilder.registerTypeAdapter(
                        multiTypeJsonParser.targetUpperLevelClass,
                        new TargetUpperLevelDeserializer(multiTypeJsonParser)
                );
            }

//            multiTypeJsonParser.parseGson = GsonHelper.THIS.getGson();
        ...
        private class TargetSerializer implements JsonSerializer<Object> {

            private final MultiTypeJsonParser<T> mGeneralJsonParser;

            public TargetSerializer(MultiTypeJsonParser<T> generalJsonParser) {
                mGeneralJsonParser = generalJsonParser;
            }
